...
urlpatterns = [
    ...
    path('transactions/<int:transaction_id>/register/composite/', views.composite_transaction_register, name='composite_transaction_register'),
    path('transactions/<int:transaction_id>/skip/composite/', views.composite_transaction_skip, name='composite_transaction_skip'),
